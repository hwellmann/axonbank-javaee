...
@Repository
@Dependent
public interface BankTransferRepository extends EntityRepository<BankTransferEntry, Long> {

    BankTransferEntry findOptionalByAxonBankTransferId(String axonBankTransferId);
